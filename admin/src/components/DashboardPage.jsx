            ...
            <div className={dashboardStyles.contentContainer}>
                ...
                <div className={dashboardStyles.statsGrid}>
                    {stats.map((stat, index) => {
                        ...
                        return (
                            <div key={stat.title} className={dashboardStyles.statCard} style={{
                    ...
                    <div className={dashboardStyles.coursesHeader}>
                        ...
                        <div className={dashboardStyles.searchContainer}>
                            ...
                            <input type="text" placeholder='Search Courses...' value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)} className={dashboardStyles.searchInput}
                            />
                        </div>
                    </div>
                                    ...
                                    >
                                        <td className='px-4 sm:px-6 py-3 sm:py-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div>
                                                    <p className={dashboardStyles.courseName}>{course.name}  
                                                    </p>
