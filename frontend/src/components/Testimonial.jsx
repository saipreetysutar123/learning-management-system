        ...
        <section className={testimonialStyles.section}>
            ...
            <div className={testimonialStyles.grid}>
                {testimonials.map((t, i) => (
                    <div onMouseMove={(e) => onMouseMove(e, cardsRef.current[i], i)} onMouseLeave={(e) => onMouseLeave(cardsRef.current[i])} key={t.id} className={testimonialStyles.cardWrapper}>
                        ...
                        <article ref={(el) => (cardsRef.current[i] = el)} className={testimonialStyles.card} style={{
                            ...
                            <div className={testimonialStyles.content}>
                                <div className={testimonialStyles.avatarContainer}>
                                    <div className={testimonialStyles.avatarWrapper}>
                                        <img src={t.avatar} alt="avatars" className={testimonialStyles.avatarImage} loading='lazy' />
                                    </div>
