...
const ContactPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const whatsappUrl = `https://wa.me/9106993449?text=${whatsappMessage}`;
                    ...
                    <div className={contactStyles.formContainer}>
                        ...
                        <div className={contactStyles.form}>
                            <form className={contactStyles.formElements} onSubmit={handleSubmit}>
                                ...
                                <div className={contactStyles.formGrid}>
                                    <div className={contactStyles.formGroup}>
                                        <label className={contactStyles.label}>
                                            <User className={`${contactStyles.label} ${contactStyles.colors.purple.icon}`} />
                                            Full Name *
                                        </label>
                                        <input type="text" name="name" value={formData.name} onChange={handleChange} required className={`${contactStyles.input} ${contactStyles.colors.purple.focus} ${contactStyles.colors.purple.hover} `} placeholder='Enter your full name' />
                                    </div>

                                    <div className={contactStyles.formGroup}>
                                        <label className={contactStyles.label}>
                                            <Mailbox className={`${contactStyles.label} ${contactStyles.colors.blue.icon}`} />
                                            Email Address *
                                        </label>
                                        <input type="email" name="email" value={formData.email} onChange={handleChange} required className={`${contactStyles.input} ${contactStyles.colors.blue.focus} ${contactStyles.colors.blue.hover} `} placeholder='Enter your email' />
                                    </div>
                                </div>
                                ...
                                <div className={contactStyles.formGroup}>
                                    <label className={contactStyles.label}>
                                        <MessageCircleDashed className={`${contactStyles.labelIcon} ${contactStyles.colors.blue}`} />
                                        Message *
                                    </label>
                                    <textarea name="message" value={formData.message} onChange={handleChange} required rows='5' className={`${contactStyles.textarea} ${contactStyles.colors.blue.focus}`} placeholder='Tell us about your project or inquiry...'></textarea>
                                </div>
