...
const HomeCourses = () => {
    ...
    //clerk
    const { isSignedIn, user } = useUser(); //user is null if not signedIn
            ...
            <div className={homeCoursesStyles.mainContainer}>
                    ...
                    <>
                        <div className={homeCoursesStyles.coursesGrid}>
                            {courses.map((course) => {
                                ...
                                return (
                                    <div key={course.id} onClick={() => handleCoursesClick(course.id)} className={homeCoursesStyles.courseCard} >
                ...
                <div className={homeCoursesStyles.ctaContainer}>
                    <div className={homeCoursesStyles.ctaWrapper}>
                        <span className={homeCoursesStyles.ctaGlow} aria-hidden="true"
