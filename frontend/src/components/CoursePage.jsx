...
import { Search, Star, User, X, SmilePlus } from 'lucide-react';
...
const CoursePage = () => {
    ...
    // to send rating request to server
            ...
            <div className={coursePageStyles.headerContainer}>
                ...
                <div className={coursePageStyles.searchContainer}>
                    ...
                    <div className={coursePageStyles.searchInputContainer}>
                        ...
                        <input type="text" placeholder='Search courses by name, instructor, or category...' value={searchQuery} onChange={(e) => {
                                                ...
                                                <div className={coursePageStyles.courseInfo}>
                                                    ...
                                                    <div className={coursePageStyles.ratingContainer}>
                                                        <div className={coursePageStyles.ratingStars}>
                                                            ...
                                                            >
                                                                <RatingStars courseId={course.id} userRating={userRating}
                                                                avgRating={course.avgRating} totalRatings={course.totalRatings} />
                                                            </div>
                                                        </div>
                                                    </div>
